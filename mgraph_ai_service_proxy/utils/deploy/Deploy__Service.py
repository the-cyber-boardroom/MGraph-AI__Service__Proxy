...
from mgraph_ai_service_proxy.config                                  import SERVICE_NAME, LAMBDA_DEPENDENCIES__FAST_API_SERVERLESS
from mgraph_ai_service_proxy.fast_api.lambda_handler                 import run
